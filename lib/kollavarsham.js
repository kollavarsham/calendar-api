...
var getCalendarDay = function (kollavarshamDate, useMalayalam) {
  ...
  var day = {
    ...
    malayalamMonth : kollavarshamDate.calendarData.malayalaMasa,
    malayalamDay   : kollavarshamDate.date,
    naksatra       : kollavarshamDate.calendarData.malayalaNaksatra,
    paksa          : kollavarshamDate.calendarData.paksa,
    tithi          : kollavarshamDate.calendarData.tithiDay
  };
  if (useMalayalam) {
    day.weekdayName = kollavarshamDate.mlWeekdayName;
    day.malayalamMonth = kollavarshamDate.calendarData.mlMalayalaMasa;
    day.naksatra = kollavarshamDate.calendarData.mlMalayalaNaksatra;
  }
  return day;
};
