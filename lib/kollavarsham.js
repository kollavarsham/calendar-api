...
const getCalendarDay = (kollavarshamDate, useMalayalam) => {
...
const mergeJSON = (calendarDay, output) => {
...
const convertGregorianDays = (startDate, jsonOutput, untilDateCallback, lang) => {
...
module.exports = {
  ...
  getMonth : (year, month, lang) => {
    ...
    const untilYearAndMonthMatch = (currentDate) => {
  ...
  getDay   : (year, month, day, lang) => {
    ...
    const untilYearMonthAndDayMatch = (currentDate) => {
